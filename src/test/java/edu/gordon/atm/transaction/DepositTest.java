...
public class DepositTest 
{
	...
	public void reflect() throws Exception
	{
		...
		deposit = new Deposit(receiptPrinter, networkToBank, cashDispenser, envelopeAcceptor, bankname, id, place, cardReader, customerConsole, card, pin);
	}
	...
	public void depositTest() throws Exception
	{
		...
		assertTrue(message.getMessageCode() == 1);
