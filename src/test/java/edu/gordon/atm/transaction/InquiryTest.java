...
public class InquiryTest 
{
	...
	public void reflect() throws Exception
	{
		...
		inquiry = new Inquiry(receiptPrinter, networkToBank, cashDispenser, envelopeAcceptor, bankname, id, place, cardReader, customerConsole, card, pin);
	}
	
	@Test
	public void inquiryTestSuccess() throws Exception
	{
		...
		assertTrue(message.getMessageCode() == 4);
